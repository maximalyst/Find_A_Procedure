import sqlite3
import os
from string import ascii_uppercase# needed for A-Z string shortcut 'string.ascii_uppercase'
...
# Versions:
# .01 and .02 were just getting basic syntax errors ironed out
# .03 adds initial SQL calls for functions
        ...
        if (section != 'P') and (section != 'H'):
            ...
            if section == 'H': # IDGAF about heliports in MVP
                ...
                if   subsection == 'A':
                    ...
                    cursr.execute('''INSERT OR IGNORE INTO Airport (name) VALUES (?)''', (airportID,))
                elif subsection == 'G':
                    airport = this[6:10]
